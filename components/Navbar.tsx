      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/search" className="text-slate-600 hover:text-blue-600 font-medium transition-colors">Search</Link>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-b border-slate-200 pb-4 px-4">
          <div className="flex flex-col gap-4">
            ...
            <Link href="/search" onClick={() => setIsOpen(false)} className="text-slate-600 hover:text-blue-600 font-medium py-2">Search</Link>
